 ...
 * @author X1
 */
public class QuanLySanPhamdoroi extends javax.swing.JInternalFrame {
    SanPhamService spService = new SanPhamService();
    DecimalFormat formatter = new DecimalFormat("#,###");
    /**
     * Creates new form QuanLySanPham
     */
    public QuanLySanPhamdoroi() {
        initComponents();
    ...
    void loadTableSanPhloadTableSanPhamChiTietamChiTiet(ArrayList<SanPhamViewModel> ls){
    ...
    public Boolean validateSanPham(){
        ...
        v.isEmpty(txtGiaNhap, stb, "Chưa nhập giá nhập SP!");
        v.isEmpty(txtGiaNhap, stb, "Chưa nhập giá bán SP!");
        if (stb.length()>0) {
    ...
    private void initComponents() {
        ...
        btnLoadHide = new javax.swing.JButton();
        ...
        tblSPCT.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SP", "Mã SPCT", "Tên SP", "Danh Mục", "Màu Sắc", "Kích Cỡ", "Giá Nhập", "Giá Bán", "Trạng Thái", "Số Lượng"
            }
        ));
        ...
        btnLoadHide.setText("HIỂN THỊ ẨN");
...
//        clearText();
    ...
    private void btnHideTTMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnHideTTMouseClicked
        ...
        if (result == JOptionPane.YES_OPTION) {
            ...
            if (!rdoTTKC.isSelected() && !rdoTTMS.isSelected()) {
                // Hiển thị thông báo lỗi nếu không có lựa chọn nào được chọn
                JOptionPane.showMessageDialog(this, "Vui lòng chọn loại thuộc tính để ẩn!", "POLYPOLO lỗi", JOptionPane.ERROR_MESSAGE);
            } else {
                // Thực hiện ẩn thuộc tính nếu có lựa chọn được chọn
                if (rdoTTKC.isSelected()) {
                    spService.hideTTSz(getModelSz());
                    loadTableByThuocTinhSz(spService.getListHideTTSz()); // Chỉ load bảng thuộc tính kích cỡ khi rdoTTKC được chọn
                }
                if (rdoTTMS.isSelected()) {
                    spService.hidetTTMS(getModelMs());
                    loadTableByThuocTinhMauSac(spService.getListHideTTMS()); // Chỉ load bảng thuộc tính màu sắc khi rdoTTMS được chọn
                }
    ...
    private javax.swing.JButton btnLoadHide;
